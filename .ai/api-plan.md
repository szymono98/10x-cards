...
<!-- Note: Field names in request and response examples (source_text, generation_id, flashcards_proposals, generated_count) are in line with the definitions in types.ts -->
